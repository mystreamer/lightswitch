...
class ViewBuilderTest(unittest.TestCase):
    def setUp(self):
        ...
        self.test_dict = {'label': [1, 1, 2, 2], 'text': [
    ...
    def test_outer_left_join(self):
        ...
        assert ret == {'x': ["A", "A", "C", "B"],
                       'y': [1, 1, 3, 2], 'z': [9, 4, 2, None]}
    ...
    def test_aggregate_text_on_columns_no_delim(self):
        tx = {"A": ["Hello1", "Hello2", "Hello3"], "B": [
            "World1", "World2", "World3"], "C": ["!1", "!2", "!3"]}
    ...
    def test_aggregate_text_on_columns_delim(self):
        tx = {"A": ["Hello1", "Hello2", "Hello3"], "B": [
            "World1", "World2", "World3"], "C": ["!1", "!2", "!3"]}
        res = vb.aggregate_text_on_columns(
            tx, cols=["A", "B", "C"], delim=". ")
        assert res == ["Hello1. World1. !1",
                       "Hello2. World2. !2", "Hello3. World3. !3"]
